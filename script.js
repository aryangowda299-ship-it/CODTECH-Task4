...
if (document.body.dataset.page === "details") {
  const courseData = {
    js: {
      ...
      description: "A build-first track that takes you from JavaScript essentials to modern coding patterns for responsive web applications.",
      video: "https://youtu.be/BI1o2H9z9fo?si=_9aFCPIK8OE9GZHH",
      instructor: "Nikhil Rao",
      instructorBio: "Frontend architect with 9+ years of mentoring beginners and helping teams ship practical web products.",
      duration: "10h 30m",
    ...
    ui: {
      ...
      description: "Build scalable design systems, reusable components, and polished interfaces used in modern product teams.",
      video: "https://youtu.be/opTANvl9G1g?si=6I0ae09sALMqB7FS",
      instructor: "Mira Dsouza",
      instructorBio: "Product designer and systems consultant focused on consistent, accessible interfaces for startup teams.",
      duration: "8h 10m",
      level: "Beginner",
      rating: "4.9",
      modules: [
    ...
    biz: {
      ...
      description: "Craft confident narratives for pitches, leadership updates, and product communication using practical frameworks.",
      video: "https://youtu.be/xKOnbcAp9go?si=Rr6l2sTyo03UMnRh",
      instructor: "Sanjana Iyer",
      instructorBio: "Communication coach who trains student founders and product teams on high-impact storytelling.",
      duration: "6h 45m",
      level: "All Levels",
      rating: "4.6",
      modules: [
    ...
    data: {
      ...
      description: "Understand analytics workflows from data cleaning to dashboard reporting and make decisions with confidence.",
      video: "https://youtu.be/wQQR60KtnFY?si=cxwgv91En7yKxg4Y",
      instructor: "Aditya Shah",
      instructorBio: "Data analyst and mentor who teaches beginner-friendly analytics with practical examples from real projects.",
      duration: "11h 00m",
      level: "Beginner",
      rating: "4.7",
      modules: [
...
if (contactForm && formMessage) {
  contactForm.addEventListener("submit", (event) => {
    ...
    formMessage.textContent = "Request sent successfully. Our team will contact you soon.";
